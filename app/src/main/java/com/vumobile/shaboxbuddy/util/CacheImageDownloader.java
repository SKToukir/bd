...
public class CacheImageDownloader {
	...
	private final HashMap<String, Bitmap> sHardBitmapCache = new LinkedHashMap<String, Bitmap>(
		...
		protected boolean removeEldestEntry(
            ...
            Log.i("Tracker", "This is RemoveEldestEntry in jCacheImageDownloder");
...
*/	public void download(final String url, final ImageView imageView) {
	...
	public void download(final String url, final ImageView imageView,
			final String cookie) {
        Log.i("Tracker", "This is Download");
		resetPurgeTimer();
	...
	private void forceDownload(final String url, final ImageView imageView,
        ...
        Log.i("Tracker", "This is forceDownload in CacheImaeDownloader");
	...
	private static boolean cancelPotentialDownload(final String url,
        ...
        Log.i("Tracker", "This is cancelPotentialDownload in CacheImageDownloader");
	...
	private static BitmapDownloaderTask getBitmapDownloaderTask(
			final ImageView imageView) {
        Log.i("Tracker", "This is BitmapDownloaderTask in CacheImageDownloader");
		if (imageView != null) {
	...
	private Bitmap getBitmapFromCache(final String url) {
        Log.i("Tracker", "This is getBitmapFromCache in CacheImageDownloader");
		...
		if (bitmapReference != null) {
            Log.i("Tracker", "This is bitmapReference in CacheImageDownloader");
	...
	class BitmapDownloaderTask extends AsyncTask<String, Void, Bitmap> {
		...
		public BitmapDownloaderTask(final ImageView imageView) {
            ...
            Log.i("Tracker", "This is Bitmap downloader task in CacheImageDownloader");
		}
	...
	static class DownloadedDrawable extends ColorDrawable {
		...
		public DownloadedDrawable(
            ...
            Log.i("Tracker", "This is DownloadeedDrawable in CacheImageDownloader");
